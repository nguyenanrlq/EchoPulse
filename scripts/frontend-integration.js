 ...
 * This file demonstrates how to integrate Echopulse with a web frontend
 */

// For React/Vue/Angular applications
export class EchopulseClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EchopulseClient(provider, contractAddress);
